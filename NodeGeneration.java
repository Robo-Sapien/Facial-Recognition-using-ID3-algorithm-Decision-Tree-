...
{
		//ArrayList structure to get maintain records attributes for which every time the tree is being splitted and it can not be used furthur
		...
		//A parameterized constructor to initialized variable values and a whole ArrayList has been passed
